#!/usr/bin/env python3
"""
s05: TodoWrite — s04 hooks + 16 tools + todo_write planning.

  + todo_write tool — plan before execute
  + Nag reminder after 3 rounds without todo update
  + Full s04: permission hooks, session.jsonl, timing, 16 tools
...
# ═══════════════════════════════════════════════════════════
#  agent_loop — s04 hooks + s05 nag reminder
# ═══════════════════════════════════════════════════════════
